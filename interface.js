var Interface = (function() {
    var InterfaceObj,
     ...
     InterfaceObj = function (args) {
     	...
     	args.implementation.id = args.id;
     	_verifyImplementation(args, args.implementation, result, args.id);

     	return result;
     };

     function createInterface(interfaceObj) {
     	return function (implementation) {
     		interfaceObj.implementation = implementation;
     		return new InterfaceObj(interfaceObj);
     	};
     }
